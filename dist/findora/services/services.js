...
export const getOwnedUtxo = async (sid) => {
...
export const waitUtxoEnough = async (publickey, length = 1, counter = 20) => {
...
export const getTransactionBuilder = async (data) => {
