...
export type SimBridgeMethodNames = 'new' | 'adminSetFee' | 'adminSetPrismBridgeAddress' | 'bar2abarFee' | 'convertFee' | 'depositFRA' | 'depositFRC20' | 'owner' | 'prismBridgeAddress' | 'prismBridgeLedger' | 'renounceOwnership' | 'transferOwnership';
