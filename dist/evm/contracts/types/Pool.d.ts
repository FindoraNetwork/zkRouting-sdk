...
export type ContractContext = Web3ContractContext<PoolAbi, PoolAbiMethodNames, PoolAbiEventsContext, PoolAbiEvents>;
export type PoolAbiEvents = 'FeeUpdated' | 'Initialized' | 'LiquidityAdded' | 'LiquidityRemoved' | 'MinAddUpdated' | 'OwnershipTransferred' | 'Paused' | 'PoolFeeAdd' | 'Unpaused';
