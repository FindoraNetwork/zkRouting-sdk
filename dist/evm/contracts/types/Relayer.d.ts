...
export type ContractContext = Web3ContractContext<RelayerAbi, RelayerAbiMethodNames, RelayerAbiEventsContext, RelayerAbiEvents>;
export type RelayerAbiEvents = 'DepositFromOtherChain' | 'FeeUpdated' | 'Initialized' | 'LiquidityAdded' | 'LiquidityRemoved' | 'MinAddUpdated' | 'OwnershipTransferred' | 'Paused' | 'PoolFeeAdd' | 'Unpaused' | 'WithdrawFRA' | 'WithdrawFRC20';
