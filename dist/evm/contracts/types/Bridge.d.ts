...
export type BridgeEvents = 'Deposit' | 'FailedHandlerExecution' | 'Paused' | 'ProposalEvent' | 'ProposalVote' | 'RelayerAdded' | 'RelayerRemoved' | 'RelayerThresholdChanged' | 'RoleGranted' | 'RoleRevoked' | 'Unpaused';
