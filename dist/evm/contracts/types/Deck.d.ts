...
export type ContractContext = Web3ContractContext<DeckAbi, DeckAbiMethodNames, DeckAbiEventsContext, DeckAbiEvents>;
export type DeckAbiEvents = 'Deposit' | 'FeeUpdated' | 'Initialized' | 'LiquidityAdded' | 'LiquidityRemoved' | 'MinAddUpdated' | 'OwnershipTransferred' | 'Paused' | 'PoolFeeAdd' | 'Unpaused' | 'Withdraw';
...
export type DeckAbiMethodNames = 'MaxFee' | 'MaxFeePercent' | 'MaxFeeShare' | 'accountAssets' | 'addLiquidity' | 'addMarket' | 'addNativeLiquidity' | 'adminColumbusAssetAddress' | 'adminSetGenericHandler' | 'allMarkets' | 'baseToken' | 'cTokenForToken' | 'columbusAssetAddress' | 'deposit' | 'feeAdmin' | 'feeCounter' | 'feeShare' | 'fixedFee' | 'genericHandlerAddress' | 'getAssets' | 'initialize' | 'marketLen' | 'markets' | 'maxRedeem' | 'minAdd' | 'minFee' | 'nativeWrap' | 'owner' | 'paused' | 'removeLiquidity' | 'renounceOwnership' | 'setFee' | 'setFeeAdmin' | 'setFeeShare' | 'setFixedFee' | 'setMarket' | 'setMinAdd' | 'setWrap' | 'tokenForCToken' | 'transferOwnership' | 'withdraw' | 'withdrawFee';
