...
export type ContractContext = Web3ContractContext<
  RelayerAbi,
  RelayerAbiMethodNames,
  RelayerAbiEventsContext,
  RelayerAbiEvents
>;
export type RelayerAbiEvents =
  | 'DepositFromOtherChain'
  | 'FeeUpdated'
  | 'Initialized'
  | 'LiquidityAdded'
  | 'LiquidityRemoved'
...
export interface RelayerAbiEventsContext {
  ...
  LiquidityAdded(
    parameters: {
      filter?: { provider?: string | string[]; token?: string | string[] };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
    },
  ...
  LiquidityRemoved(
    parameters: {
      filter?: { receiver?: string | string[]; token?: string | string[] };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
    },
  ...
  WithdrawFRA(
    parameters: {
      filter?: { to?: string | number[] | string | number[][] };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
    },
  ...
  WithdrawFRC20(
    parameters: {
      filter?: { token?: string | string[]; to?: string | number[] | string | number[][] };
      fromBlock?: number;
      toBlock?: 'latest' | number;
      topics?: string[];
    },
...
export type RelayerAbiMethodNames =
  | 'MaxFee'
  | 'MaxFeePercent'
  | 'MaxFeeShare'
  | 'accountAssets'
  ...
  | 'addMarket'
  | 'addNativeLiquidity'
  | 'adminSetBridgeAddress'
  | 'adminSetColumbusAssetAddress'
  | 'adminSetGenericHandler'
  | 'adminSetGenericHandlerResourceId'
  | 'adminSetPrismAddress'
  | 'adminSetPrismLedgerAddress'
  | 'allMarkets'
  | 'baseToken'
  | 'bridgeAddress'
  | 'cTokenForToken'
  | 'columbusAssetAddress'
  | 'depositFromOtherChain'
  | 'feeAdmin'
  | 'feeCounter'
  | 'feeShare'
  ...
  | 'owner'
  | 'paused'
  | 'prismxxBridgeAddress'
  | 'prismxxLedgerAddress'
  | 'removeLiquidity'
  | 'renounceOwnership'
  | 'setFee'
  | 'setFeeAdmin'
...
export interface RelayerAbi {
   ...
   */
  initialize(
    _genericHandlerAddress: string,
    _prismxxBridgeAddress: string,
    _prismLedgerAddress: string,
    _columbusAssetAddress: string,
    _genericHandlerResourceId: string | number[],
