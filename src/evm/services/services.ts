...
export const approveToken = async (tokenAddress: string, bridgeAddress: string, amount: string) => {
...
export const getAssetCode = async (prismBridgeAddress: string, tokenAddress: string, provider?: string): Promise<string> => {
  try {
