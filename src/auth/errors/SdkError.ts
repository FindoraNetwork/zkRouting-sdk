...
export const ErrorCodeMessages: { [key in ErrorCodeValues]: string } = {
...
export type ErrorCodeValues = typeof ErrorCodes[ErrorCodeKeys];
...
export class SdkError extends Error {
  public errorCode: ErrorCodeValues;
  public description: string;
  public args: string;
  public data: { [key in string]: any } = {};
